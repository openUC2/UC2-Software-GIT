...
void executeCommand(int nINST)
{
  ...
  {
    digitalWrite(FLUO_PIN, int(INST[0])/8);
...
void setup()
{
  ...
  //setPwmFrequency(11, 1); // Necessary to prevent undervoltage - > The divisors available on pins 3 and 11 are: 1, 8, 32, 64, 128, 256, and 1024.
  digitalWrite(FLUO_PIN, int(256/8));
  delay(100);
