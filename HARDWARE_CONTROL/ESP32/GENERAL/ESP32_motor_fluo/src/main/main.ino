...
// ~~~~  Wifi  ~~~~
const char *ssid = "Blynk"; //"UC2_wifi004";
const char *password = "12345678"; //"_lachmannUC2";
WiFiClient espClient;
PubSubClient client(espClient);
// ~~~~  MQTT  ~~~~
const char *MQTT_SERVER = "192.168.43.51";//"21.3.2.152";
...
// ~~~~ MOTOR ~~~~
StepMotor stepperZ = StepMotor(27,25,32,4); //normally: 25, 26, 27, 14 // 12, 14, 27, 26
StepMotor stepperY = StepMotor(5, 17, 16, 0);
StepMotor stepperX = StepMotor(33, 32, 0, 14); // 27, 25, 32, 4 never connected to same ESP32 as stepperZ -> hence: universally possible
